            ...
            <div className="relative pt-20 pb-16 px-12 border-b border-white/5">
                <div className="max-w-6xl mx-auto relative z-10">
                    <div className="mb-8 flex">
                        <div className="p-5 bg-gradient-to-br from-red-600 to-red-800 rounded-2xl shadow-2xl shadow-red-900/40 transform -rotate-3 border border-red-500/50 hover:rotate-0 transition-transform duration-300 group cursor-default">
                             {/* Custom Rails Gym Logo: A Ruby Gem containing a Dumbbell */}
                             <svg className="w-16 h-16 text-white drop-shadow-md transform group-hover:scale-105 transition-transform duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                                {/* The Ruby Gem Shape */}
                                <path d="M6 3L2 9L12 22L22 9L18 3H6Z" stroke="white" strokeWidth="2" className="fill-white/10" />
                                {/* The Dumbbell inside */}
